...
class CoTrain:
    ...
    def save_checkpoint(self, model, optimizer, step, section):
        filename = section + "_" + "cotrain_step" + str(step) + ".pt"
        torch.save(
            {
                "cotrain_step": step,
    ...
    def get_conf_data(
        ...
        for i, batch in enumerate(dataloader_trn):
            ...
            print("this is the batch number",i)
            ...
            labels_trn = (
                np.argmax(softmax(result_trn.logits).detach().cpu().numpy(), axis=1)
                .flatten()
                .tolist()
            )
    ...
    def cotrain(self, seed):
        ...
        for i in range(1, self.cotrain_steps + 1):
            ...
            view1_labeled = self.get_conf_data(
                ...
                dataloader_trn=view2_unlabeled_dataloader,
                section="findings",
                coverage=coverage,
                other_section="impressions",
                step=i,
            ...
            print("Shape of view1_labeled", view1_labeled.shape)
            ...
            view2_labeled = self.get_conf_data(
                ...
                dataloader_trn=view1_unlabeled_dataloader,
                section="impressions",
                coverage=coverage,
                other_section="findings",
                step=i,
